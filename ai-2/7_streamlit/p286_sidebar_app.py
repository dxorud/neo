...
user_id = st.sidebar.text('아이디(ID) 입력', value='root', max_chars=15)
user_password = st.sidebar.text('패스워드(Password) 입력', value='1234', type='password')
...
st.image(img_local, width=400, caption=your_option)