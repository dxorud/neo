...
class visualization:
    ...
    def makeWordCloud(self):
        ...
        wordcloud = WordCloud(font_path=fontpath, background_color="lightyellow", relative_scaling=0.2, mask=alice_coloring)
        print(self.wordList)
    ...
    def makeBarChart(self):
        ...
        for idx in range(len(result)):
            ...
            plt.text(x=idx, y=chardata[idx] + 1, s=value, fontsize=8, ha='center')
...
stop_file = open(stop_word_file, mode='r', encoding='utf-8')
