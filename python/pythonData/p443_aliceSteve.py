...
filename = 'p443_alice_graph01.png'
...
stevefile = 'steve.txt'
text = open(stevefile, 'r', encoding='utf-8').read()
...
filename = 'p443_alice_graph02.png'
plt.savefig(filename, dpi=400, bbox_inches='tight')
print(filename + ' saved')
...
wc = WordCloud(background_color='white', mask=alice_color_mask, stopwords=mystopwords, max_words=2000,
...
filename = 'p443_alice_graph03.png'
plt.savefig(filename, dpi=400, bbox_inches='tight')
print(filename + ' saved')
...
filename = 'p443_alice_graph04.png'
plt.savefig(filename, dpi=400, bbox_inches='tight')
print(filename + ' saved')
...
filename = 'p443_alice_graph05.png'
plt.savefig(filename, dpi=400, bbox_inches='tight')
print(filename + ' saved')
plt.show()